        ...
        <div class="box">
          <div class="border-right">
            <div class="border-left">
              <div class="inner">
                <h3>NEW CUSTOMER <span>REGISTRATION </span></h3>
                <p>
            <table>
                  <tr><td bgcolor="aqua">
<b><h2><marquee behavior="scroll" direction="left"> CUSTOMER <span> REGISTRATION </marquee>
    <marquee behavior="scroll" direction="right">Please Enter <span>Correct Details </p></marquee>
</td>
    <td>
    <p> NAME: 
